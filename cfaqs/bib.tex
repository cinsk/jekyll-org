...
\bibitem[ANSI]{ansi} American National Standards Institute,
	...
	--- Programming Language --- C}, ANSI X3.159--1989 (질문 11.2 참고).

\bibitem[Rationale]{rationale} American National Standards Institute, 
	\IT{Rationale for American National Standard for Information Systems
	--- Programming Language --- C} (질문 11.2 참고).
...
\bibitem[POSIX]{posix}
	...
	IEEE Std.\  1003.1, \cite{iso}/IEC 9945--1.
...
\bibitem[Wu]{agrep}
	...
	개정된 Indian Hill 스타일 가이드 (질문 17.9 참고)에는 다른 참고
	문헌들이 있습니다.  질문 18.10을 참고하기 바랍니다.
