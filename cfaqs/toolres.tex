...
\Q{18.1}
	도움이 될만한 프로그램이 필요합니다.
\A
	아래의 테이블을 참고하기 바랍니다 (\seealso{18.16}):
...
tracking down \TT{malloc} problem & 질문 18.2 참고 \\ \hline
``selective'' C preprocessor & 질문 10.18 참고 \\ \hline
language translation tool & 질문 11.31 참고 \\ \hline
C verifier (lint) & 질문 18.7 참고 \\ \hline
C compiler & 질문 18.3 참고 \\ \hline \hline
\end{tabular}
\normalsize
	...
	여러 툴에 대한 다른 목록과 논쟁은 유즈넷 \TT{comp.compilers}와
	\TT{comp.software-eng}에서 찾아 볼 수 있습니다.
...
\begin{verbatim}
  htpp://www.gnu.org/software/indent/
\end{verbatim}
...
\A
	...
	MS-DOS 용으로 포팅한 djgpp도 있습니다.  홈페이지는
	\TT{http://www.delorie.com/djgpp/}입니다.
	...
	\TT{comp.compilers}에 관련된 아카이트에는 컴파일러, 인터프리터,
	문법(grammer) 등에 대한 굉장히 많은 정보가 들어 있습니다.
	(FAQ 리스트를 포함한) \TT{comp.compilers} 아카이브는 iecc.com에서
	...
	\TT{ftp.idiom.com}의 \TT{pub/compilers-list/}에서 구할 수 있습니다.
	(\TT{rtfm.mit.edu} 또는 \TT{ftp.uu.net}의 \TT{comp.compilers}
	디렉토리에서 \TT{news.answers}에 관한 아카이브도 참고하기 바랍니다;
	질문 20.40도 참고하기 바랍니다.)

\T
	이 답변은 상대적으로 오래된 것입니다.   GCC는 원래 ``GNU C Compiler''의
	...
	\TT{http://www.gnu.org/software/gcc/}를 방문하시면 얻을 수 있습니다.
...
\A
	...
	정확한 prototype을 썼는지 검사해야 합니다.  질문 1.7과 10.6을
	참고하기 바랍니다.
\end{faq}
...
\end{verbatim}
	...
	대한 목록을 유지하고 있습니다.  이 목록은 \TT{comp.lang.c}와
 	\TT{comp.lang.c++}에 게시되며 이 FAQ list가 있는 곳에 (질문 20.40
	참고), 같이 보관되어 있으며,
	\TT{http://www.cyberdiem.com/vin/learn.html}에서 구할 수 있습니다.

	\end{itemize}

	\seealso{18.10, 18.15c}
...
\end{verbatim}
	...
	있습니다; 필요하면 보내드리고 있습니다.  \seealso{18.9}
\end{faq}
...
\A
	...
	두 개의 패키지가 각각 \TT{comp.sources.misc}에 1993년 12월에,
	\TT{alt.sources}에 1994년 1월에 게시되었지만, 지금은 없습니다.
	대신 \TT{sunsite.unc.edu}의
	\TT{pub/packages/development/libraries/defunc-1.3.tar.Z}로
	...
	파싱/평가하는 코드는 \EM{Software Solutions in C}의
	Chapter 12, \mbox{페이지 235--55}에서도 찾아볼 수 있습니다.
\end{faq}
...
\A
	완벽한 문법은 물론 ANSI 표준에 들어 있습니다; 질문 11.2를
	보기 바랍니다.  다른 분멉으로는 (C++과 관련된) Jim Roskind씨가
...
\A
	...
	\TT{http://www.brokersys.com/snippets/}에서 얻을 수 있습니다.

	Lars Wirzenius씨의 ``public'' 라이브러리는 \TT{ftp.funet.fi}의
	\TT{pub/language/C/Publib/}에서 얻을 수 있습니다.

	\seealso{14.12, 18.9, 18.13, 18.16}
...
\A
	...
	(\TT{ftp.uu.net}의 
	\TT{/systems/unix/bsd-sources/}....\TT{/src/lib/libc/quad/*}
	에서 구할 수 있으며, GNU MP 라이브러리, 또 MIRACL 패키지
	(\TT{http:://indigo.ie/~mscott/} 참고), 그리고 오래된 Unix에서
	제공되는 libmp.a를 참고 바랍니다.  \seealso{14.12, 18.16}
...
\A
	...
	널리 알려진, 공개를 취지로 한 아카이브 사이트들을 예로 들면,
