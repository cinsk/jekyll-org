...
Standard C can be referred to in several ways. It was orinally written by
...
\A
	...
	ISO/IEC 9899:1990으로 대체하여 국제 표준으로 만들었습니다.
...
\T
	\cite{hs5} 소개 부분에 나온 내용을 인용 및 요약하면 
        ...
        ``K\&R''이라고 부르며, 1980년대에 쓰였던 모든 C 언어를 ``traditionall
        C''라고 합니다.
...
\end{verbatim}
	...
	ISO/IEC C9X의 진행판은 JTC1/SC22/WG14 사이트인
...
\A
	...
	대개는 이 두 스타일을 섞어 쓰는 것이 가능하지만(질문 \ql{11.4} 참고)
	이 경우에는 안됩니다.
...
\A
	섞어 쓸 수 있긴 하지만 매우 주의를 필요합니다.  (질문 \ql{11.3}을 꼭
...
\R	\cite{c89} \S\ 6.1.2.6, \S\ 6.3.16.1, \S\ 6.5.3 \\
...
\end{verbatim}
	...
	얼마든지 바꿀 수 있습니다.) 질문 \ql{11.12b}부터 \ql{11.15}까지 참고하기
	바랍니다.
...
\A
	...
	포함됩니다.
\R
	\cite{c89} \S\ 6.8.6; \cite{hs} \S\ 3.7 \page{61}
\end{faq}
...
\R
	\cite{c89} \S\ 6.1.2.5, \S\ 6.3.6; \cite{hs} \S\ 7.6.2 \page{204}
\end{faq}
...
\A
	ANSI/\cite{c89} 표준은 둘 중 하나일 수 있다고 말하고 있습니다; 그 결과는
...
\A
	오래된 링커(linker)의 경우, ANSI/\cite{c89} C나, C 컴파일러
...
\A
	...
	종종 있는 일입니다.) 질문 \ql{11.29}, \ql{13.25}, \ql{13.26}을 참고하기 바랍니다.
\end{faq}
...
``spirit of C,'' several issues ar enot precisely specified; portable programs
...
\A
	...
	이런 것에 의존하는 것은 매우 나쁩니다.  질문 \ql{11.32}와 \ql{11.33}, \ql{11.34}를
	참고하기 바랍니다.
\end{faq}
