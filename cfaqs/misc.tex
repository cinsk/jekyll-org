...
\begin{description}
\item[기타 테크닉]     \ql{20.1} -- \ql{20.6}
\item[비트와 바이트]   \ql{20.7} -- \ql{20.12}
\item[효율성]          \ql{20.12} -- \ql{20.16}
\item[switch 문장]     \ql{20.16} -- \ql{20.18}
\item[기타 언어 기능]  \ql{20.19} -- \ql{20.24}
\item[다른 언어들]     \ql{20.25} -- \ql{20.27}
\item[알고리즘]        \ql{20.28} -- \ql{20.33}
\item[만물상]          \ql{20.34} -- \ql{20.40}
\end{description}
...
\A
	\TT{mktime()}과 \TT{localtime()}을 쓰면 됩니다.  (\seealso{\ql{13.13}, \ql{13.14}}.
