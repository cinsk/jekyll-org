...
\A
	...
	ANSI/\cite{c89} C 표준에는 이러한 함수들이 어떤 값이 전달되더라도
	안전하게 동작한다고 씌여 있습니다.
...
\A	The conversions must be in the comparison function, which must
	...
	discussed in question \ql{13.8} above.   The comparison function might
	look like
...
\end{verbatim}
	...
	you'll need indirection, as in question \ql{13.8}:
...
\A
	...
	생각할 수도 있습니다: 질문 \ql{19.27}과 \ql{19.30}을 참고하기 바랍니다.
\R
...
\A
	이러한 문제를 해결하기 위해서 ANSI/\cite{c89} 표준 C에서는
...
\A
	...
	있습니다: r250, RANLIB, FSULTRA (질문 \ql{18.16}을 보기 바랍니다.)
\R
